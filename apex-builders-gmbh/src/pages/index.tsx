...
export default function Home() {
  return (
    <>
      <Head>
        <title>Apex Builders GmbH – Modern Construction Solutions</title>
        <meta
          name="description"
          content="Apex Builders offers sustainable and modern construction services across Europe."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />

        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Apex Builders GmbH" />
        <meta
          property="og:description"
          content="Modern construction with sustainable solutions."
        />
        <meta
          property="og:image"
          content="https://apex-builders-gmbh.vercel.app/og-image.jpg"
        />
        <meta
          property="og:url"
          content="https://apex-builders-gmbh.vercel.app/"
        />
        <meta property="og:type" content="website" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Apex Builders GmbH" />
        <meta
        ...
        <meta
          name="twitter:image"
          content="https://apex-builders-gmbh.vercel.app/twitter-card.jpg"
        />
      </Head>
